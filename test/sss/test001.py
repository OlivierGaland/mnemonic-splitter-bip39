...
def main():
    ...
    s = MnemonicSSSSplitter(mnemonic=MNEMONIC_000,language=LANGUAGE_000)
    s.split(6,4)
    shares = s.mnemonic_with_index_list
    ...
    m = MnemonicSSSMerger(mnemonic_list=shares_sample,language=LANGUAGE_000)
    m.merge()
